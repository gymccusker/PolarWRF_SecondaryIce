...
ax.plot(MAC['Temp']-273.15, MAC['Ni_997'],'k--',label='Extremes (MAC)')
ax.plot(T3D-273.15, niobs_nanmean,color='dimgrey',label='Mean (27-Nov)',linewidth=3)
ax.plot(T3D-273.15, niobs_997,'--',color='dimgrey',label='Extremes (27-Nov)')
ax.plot(T3D-273.15, ni1_nanmean,'r',label='Mean (PolarWRF)',linewidth=3)
ax.plot(T3D-273.15, ni1_997,'r--',label='Extremes (PolarWRF)')
ax.set_xlim([-9,-3])
...
ax.plot(T3D-273.15, niobs_nanmean,color='dimgrey',label='Mean (27-Nov)',linewidth=3)
ax.plot(T3D-273.15, niobs_997,'--',color='dimgrey',label='Extremes (27-Nov)')
ax.plot(T3D-273.15, ni2_nanmean,'r',label='Mean (PolarWRF)',linewidth=3)
ax.plot(T3D-273.15, ni2_997,'r--',label='Extremes (PolarWRF)')
ax.set_xlim([-9,-3])
ax.set_ylim([5e-3,1e2])
ax.set_yscale("log", nonposy='clip')
# plt.title(runlab2)
...
ax.plot(T3D-273.15, niobs_nanmean,color='dimgrey',label='Mean (27-Nov)',linewidth=3)
ax.plot(T3D-273.15, niobs_997,'--',color='dimgrey',label='Extremes (27-Nov)')
ax.plot(T3D-273.15, ni3_nanmean,'r',label='Mean (PolarWRF)',linewidth=3)
ax.plot(T3D-273.15, ni3_997,'r--',label='Extremes (PolarWRF)')
ax.set_xlim([-9,-3])
ax.set_ylim([5e-3,1e2])
plt.ylabel('$N_{isg>80}$ [$L^{-1}$]')
...
ax.plot(T3D-273.15, niobs_nanmean,color='dimgrey',label='Mean (27-Nov)',linewidth=3)
ax.plot(T3D-273.15, niobs_997,'--',color='dimgrey',label='Extremes (27-Nov)')
ax.plot(T3D-273.15, ni4_nanmean,'r',label='Mean (PolarWRF)',linewidth=3)
ax.plot(T3D-273.15, ni4_997,'r--',label='Extremes (PolarWRF)')
ax.set_xlim([-9,-3])
ax.set_ylim([5e-3,1e2])
plt.xlabel('Temperature [$^{o}C$]')
ax.set_yscale("log", nonposy='clip')
...
ax.plot(T3D-273.15, niobs_nanmean,color='dimgrey',label='Mean (27-Nov)',linewidth=3)
ax.plot(T3D-273.15, niobs_997,'--',color='dimgrey',label='Extremes (27-Nov)')
ax.plot(T3D-273.15, ni5_nanmean,'r',label='Mean (PolarWRF)',linewidth=3)
ax.plot(T3D-273.15, ni5_997,'r--',label='Extremes (PolarWRF)')
ax.set_xlim([-9,-3])
ax.set_ylim([5e-3,1e2])
ax.set_yscale("log", nonposy='clip')
# plt.ylabel('$N_{isg>80}$ [$L^{-1}$]')
...
# print "Obs = Mean:",niobs_nanmean_tot," Extremes:",np.nanpercentile(NiceFreq_tot,Extremes)
# print runlab1," = Mean:",ni1_nanmean_tot," Extremes:",np.nanpercentile(Nisg_1,Extremes)
# print runlab2," = Mean:",ni2_nanmean_tot," Extremes:",np.nanpercentile(Nisg_2,Extremes)
# print runlab3," = Mean:",ni3_nanmean_tot," Extremes:",np.nanpercentile(Nisg_3,Extremes)
# print runlab4," = Mean:",ni4_nanmean_tot," Extremes:",np.nanpercentile(Nisg_4,Extremes)
# print runlab5," = Mean:",ni5_nanmean_tot," Extremes:",np.nanpercentile(Nisg_5,Extremes)

plt.savefig('../Figures/01_Domain_FreqDist_NisgvsT_vREVIEW2.svg')
plt.show()
