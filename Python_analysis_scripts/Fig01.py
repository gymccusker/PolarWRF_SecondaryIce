...
plt.step(NiceFreq[1][:-1],NiceFreqNorm,color='k',linewidth=3,label='Obs')
...
ax.plot(newtemp27-273.15,newnisg27,'.',color='lightgrey',markersize=4,label='Case study')
...
ax.plot(T3D-273.15, niobs_nanmean,color='dimgrey',label='Mean (Case)',linewidth=3)
ax.plot(T3D-273.15, niobs_997,'--',color='dimgrey',label='99.7 (Case)')
...
ax.plot(MAC['Temp']-273.15, MAC['Ni'],color='k',label='Mean (MAC)',linewidth=3)
ax.plot(MAC['Temp']-273.15, MAC['Ni_997'],'k--',label='99.7 (MAC)')
ax.plot(T3D-273.15, niobs_nanmean,color='dimgrey',label='Mean (Obs)',linewidth=3)
ax.plot(T3D-273.15, niobs_997,'--',color='dimgrey',label='99.7 (Obs)')
